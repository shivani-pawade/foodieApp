...
export class RestaurantOwnerComponent implements OnInit {
  ...
  constructor(private adminService: AdminService, private router: Router, 
    private fb: FormBuilder, private dialog: MatDialog, private updateAddService: UpdateAddFormService, 
    private _snackBar: MatSnackBar,private paginarionService: PaginationService) {
